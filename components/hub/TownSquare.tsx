...
const TownSquare: React.FC<Props> = ({ onGoTavern, onGoBlacksmith, onGoIvoryTower, onGoApothecary, onJourney }) => {
    return (
        <div className="flex-1 flex flex-col items-center justify-center p-8 bg-gradient-to-b from-gray-900 to-black relative overflow-auto">
            ...
            <div className="grid grid-cols-2 gap-8 relative z-10 w-full max-w-4xl">
                <button onClick={onGoTavern} className="h-40 bg-medieval-800/80 hover:bg-medieval-700 border-2 border-medieval-500 rounded-lg flex flex-col items-center justify-center gap-4 transition-all hover:scale-105 group">
                ...
                <button onClick={onGoBlacksmith} className="h-40 bg-medieval-800/80 hover:bg-medieval-700 border-2 border-medieval-500 rounded-lg flex flex-col items-center justify-center gap-4 transition-all hover:scale-105 group">
                ...
                <button onClick={onGoIvoryTower} className="h-40 bg-medieval-800/80 hover:bg-medieval-700 border-2 border-medieval-500 rounded-lg flex flex-col items-center justify-center gap-4 transition-all hover:scale-105 group">
                ...
                <button onClick={onGoApothecary} className="h-40 bg-medieval-800/80 hover:bg-medieval-700 border-2 border-medieval-500 rounded-lg flex flex-col items-center justify-center gap-4 transition-all hover:scale-105 group">
